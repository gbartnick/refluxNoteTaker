            ...
            <div>
                <header>
                    <ul className="nav nav-tabs">
                        <li role="presentation" className="active"><Link to="notes">Notes</Link></li>
...
var NoteItem = React.createClass({
    ...
    editItem: function(evt){
        this.setState({isEditing:true,
                       editValue: this.props.note.text}, function(){
        ...
        return(
            <tr className={classes}>
                ...
                <td>
                    ...
                    <span className="edit"><input ref="editInput" valueLink={this.linkState('editValue')} type="text" onKeyUp={this.handleValueChange} onBlur={this.handleBlur}/></span>
                </td>
                <td>{this.props.note.submittedDate}</td>
                <td><span className="btn btn-primary btn-sm" onClick={this.editItem}>Edit<i className='glyphicon glyphicon-pencil' style={iconStyle}></i></span></td>
            </tr>
        );
    }
});
